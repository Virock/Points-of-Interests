...
<html>
    ...
    <body class="container">
        <h1 class="jumbotron">Edit point of interest</h1>
        ...
        <div class="row">
            <div class="col-md-6 well col-md-offset-3">
                <form action="edit_this_poi" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="type" name="type" value="${poi_details[1]}">
                    ...
                    <button type="submit" class="btn btn-primary">Edit POI</button>
                </form>
            </div>
        </div>
        <div>
